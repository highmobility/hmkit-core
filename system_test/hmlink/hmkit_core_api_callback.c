...
{
hmkit_core_log_data(NULL,NULL,HMKIT_CORE_LOG_INFO,NULL,0,"[HMMOC Link] hmkit_core_api_callback_init");
...
{
hmkit_core_log_data(NULL,NULL,HMKIT_CORE_LOG_INFO,NULL,0,"[HMMOC Link] hmkit_core_api_callback_entered_proximity");
    //Get capabilities
    uint8_t data[3] = {0x00,0x10,0x00};
	uint8_t reqID[3] = {1, 2, 3};
	uint16_t reqID_size = 3;
...
hmkit_core_log_data(NULL,NULL,HMKIT_CORE_LOG_INFO,NULL,0,"[HMMOC Link] hmkit_core_api_callback_exited_proximity");

}

void hmkit_core_api_callback_command_incoming(uint64_t appContxtId, hmkit_core_device_t *device, uint8_t content_type, uint8_t *data, uint32_t length, uint8_t *reqID, uint16_t reqID_size, uint8_t version)
{
    hmkit_core_log_data(NULL,device->serial_number,HMKIT_CORE_LOG_INFO,data,length,"[HMMOC LINK] hmkit_core_api_callback_command_incoming");

    hmkit_core_log_data(NULL,device->serial_number,HMKIT_CORE_LOG_INFO,data,length,"[HMMOC LINK] hmkit_core_api_callback_command_incoming data");
    hmkit_core_log_data(NULL,device->serial_number,HMKIT_CORE_LOG_INFO,reqID,reqID_size,"[HMMOC LINK] hmkit_core_api_callback_command_incoming id");
}

void hmkit_core_api_callback_command_response(uint64_t appContxtId, hmkit_core_device_t *device, uint8_t content_type, uint8_t *data, uint32_t length, uint8_t *reqID, uint16_t reqID_size, uint8_t version){

    hmkit_core_log_data(NULL,NULL,HMKIT_CORE_LOG_INFO,data,length,"[HMMOC Link] hmkit_core_api_callback_command_response");
}
...
void hmkit_core_api_callback_telematics_command_incoming(uint64_t appContxtId, hmkit_core_device_t *device, uint8_t id, uint8_t content_type, uint32_t length, uint8_t *data, uint8_t *reqID, uint16_t reqID_size, uint8_t version){
hmkit_core_log_data(NULL,NULL,HMKIT_CORE_LOG_INFO,data,length,"[HMMOC Link] hmkit_core_api_callback_telematics_command_incoming data");
hmkit_core_log_data(NULL,NULL,HMKIT_CORE_LOG_INFO,reqID,reqID_size,"[HMMOC Link] hmkit_core_api_callback_telematics_command_incoming ID");
}
...
hmkit_core_log_data(NULL,NULL,HMKIT_CORE_LOG_INFO,NULL,0,"[HMMOC Link] hmkit_core_api_callback_telematics_revoke_incoming");
